...
insert into Ingredients (ingredientId, supply, name, supplierID, mealId) values (7787, 2, 'Wine - Acient Coast Caberne', 2854, 1783);
insert into Ingredients (ingredientId, supply, name, supplierID, mealId) values (4774, 188, 'Foam Tray S2', 2854, 1783);
insert into Ingredients (ingredientId, supply, name, supplierID, mealId) values (7217, 168, 'Squash - Butternut', 2854, 1783);
insert into Ingredients (ingredientId, supply, name, supplierID, mealId) values (5918, 147, 'Mushroom - Porcini Frozen', 2854, 1783);
insert into Ingredients (ingredientId, supply, name, supplierID, mealId) values (2962, 55, 'Eggplant Oriental', 2854, 1783);
insert into Ingredients (ingredientId, supply, name, supplierID, mealId) values (9683, 74, 'Wanton Wrap', 2854, 1783);
